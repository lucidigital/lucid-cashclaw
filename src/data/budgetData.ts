...
export const MOCK_BUDGET_LINES: BudgetLine[] = [
  ...
  // CHI
  { id: 'b4', projectId: 'p1', type: 'chi', category: 'nhansu',   person: 'Hùng',  description: 'Compositing 20 shot', estimatedAmount: 45_000_000, actualAmount: 40_000_000, status: 'partial' },
  { id: 'b5', projectId: 'p1', type: 'chi', category: 'chi_khac', person: undefined, description: 'Render farm', estimatedAmount: 30_000_000, actualAmount: 35_000_000, status: 'over', note: 'Vượt 5tr do re-render' },
  { id: 'b6', projectId: 'p1', type: 'chi', category: 'nhansu',   person: 'Nam',   description: 'Roto & Prep 30 shot', estimatedAmount: 15_000_000, actualAmount: 15_000_000, status: 'done' },
  { id: 'b7', projectId: 'p1', type: 'chi', category: 'nhansu',   person: 'Trung Ca', description: 'Color grading', estimatedAmount: 12_000_000, actualAmount: 10_000_000, status: 'partial' },
  { id: 'b8', projectId: 'p1', type: 'chi', category: 'vanhanh',  person: undefined, description: 'OT meals team', estimatedAmount: 5_000_000, actualAmount: 8_000_000, status: 'over' },
  ...
  // CHI
  { id: 'b13', projectId: 'p2', type: 'chi', category: 'nhansu',   person: 'Trung', description: '3D character modeling', estimatedAmount: 70_000_000, actualAmount: 60_000_000, status: 'partial' },
  { id: 'b14', projectId: 'p2', type: 'chi', category: 'nhansu',   person: 'Hùng',  description: 'Animation compositing', estimatedAmount: 50_000_000, actualAmount: 45_000_000, status: 'partial' },
  { id: 'b15', projectId: 'p2', type: 'chi', category: 'chi_khac', person: undefined, description: 'Cloud render', estimatedAmount: 25_000_000, actualAmount: 20_000_000, status: 'partial' },
  { id: 'b16', projectId: 'p2', type: 'chi', category: 'freelance', person: 'Sound Studio', description: 'Sound design', estimatedAmount: 15_000_000, actualAmount: 0, status: 'planned' },
  ...
  // CHI
  { id: 'b19', projectId: 'p5', type: 'chi', category: 'nhansu',  person: 'Linh', description: 'Offline edit', estimatedAmount: 20_000_000, actualAmount: 18_000_000, status: 'partial' },
  { id: 'b20', projectId: 'p5', type: 'chi', category: 'nhansu',  person: 'Hùng', description: 'VFX compositing', estimatedAmount: 30_000_000, actualAmount: 0, status: 'planned' },
  { id: 'b21', projectId: 'p5', type: 'chi', category: 'nhansu',  person: 'Trung Ca', description: 'Color grade', estimatedAmount: 10_000_000, actualAmount: 0, status: 'planned' },
];
